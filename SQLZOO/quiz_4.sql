...
/*
Q2. Select the code that shows the countries belonging to regions with all populations over 50000 
*/
...
/*
Q3. Select the code that shows the countries with a less than a third of the population of the countries around it 
*/
